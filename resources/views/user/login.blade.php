...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #6a11cb, #2575fc); /* Gradient biru yang elegan */
        ...
        h1 {
            ...
            color: #fff;
            font-weight: 700;
            text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3); /* Menambahkan efek bayangan pada teks */
        }
...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 mb-3">Welcome Back! <br> Login <i class="fas fa-user-lock"></i></h1>
